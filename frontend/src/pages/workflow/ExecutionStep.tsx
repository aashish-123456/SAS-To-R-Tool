          ...
          <div className="flex-1">
            ...
            {m.label === 'CPU Usage' && (
              <div className="h-1.5 bg-slate-100 rounded-full">
                <div className="h-1.5 bg-blue-500 rounded-full" style={{ width: '14%' }} />
              </div>
            )}
            {m.label === 'Memory' && (
              <div className="h-1.5 bg-slate-100 rounded-full">
        ...
        {totalPages > 1 && (
          <div className="px-6 py-3 border-t border-slate-100 flex items-center justify-between">
            ...
            <div className="flex gap-1.5">
              ...
              <span className="px-3 py-1 text-xs bg-blue-600 text-white rounded-lg font-bold">{page + 1}</span>
              <button
        ...
        return (
          <div key={name} className="bg-white rounded-xl border border-slate-200 p-4">
            ...
            <button
              ...
              className="mt-3 w-full flex items-center justify-center gap-1.5 py-1.5 text-xs font-semibold text-blue-600 border border-blue-200 rounded-lg hover:bg-blue-50 transition-colors"
            >
            ...
            <div className="w-full max-w-xs space-y-2 mt-2">
              {['SAS Code Parsing', 'AST Generation', 'R Translation', 'SAS Execution', 'R Execution'].map((s, i) => (
                <div key={s} className="flex items-center gap-2.5">
                  <Loader2 className={`w-3.5 h-3.5 text-blue-500 ${i <= 2 ? 'animate-spin' : 'opacity-30'}`} />
                            ...
                            <div key={name}>
                              ...
                              {info.rows > 5 && (
                                <p className="text-xs text-slate-400 mt-1.5">
                                  ...
                                  <button onClick={() => setPreviewDataset(name)} className="text-blue-600 hover:underline">
                                    view all
                                  </button>
                                </p>
                              )}
        ...
        <div className="flex flex-wrap gap-3">
          ...
          {hasResult && (
            <>
              <button
                onClick={() => navigate(`/projects/${projectId}/translation`)}
                className="flex items-center gap-2 px-4 py-2.5 border border-blue-200 text-blue-700 rounded-xl hover:bg-blue-50 text-sm font-semibold transition-colors"
              >
          ...
          <button
            ...
            disabled={!hasResult}
            className="flex items-center gap-2 px-5 py-2.5 bg-blue-600 text-white rounded-xl hover:bg-blue-700 text-sm font-bold transition-colors disabled:opacity-40 disabled:cursor-not-allowed shadow-sm"
          >
            {isRunning ? (
